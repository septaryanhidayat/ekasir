...
class TenantController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'ewallet_account_number' => 'nullable|string|max:100',
        ...
        Tenant::create([
            ...
            'ewallet_account_number' => $request->ewallet_account_number,
            'ewallet_account_holder' => $request->ewallet_account_holder,
