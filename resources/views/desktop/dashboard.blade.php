...
@endif
    ...
    <div x-show="showImportModal" x-transition class="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" style="display: none;">
        <div @click.away="showImportModal = false" class="bg-white rounded-3xl p-6 w-full max-w-md shadow-2xl space-y-4 text-slate-800">
            ...
            <form action="{{ route('backup.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4 text-xs">
                @csrf
                <div>
                ...
                <div class="flex justify-end space-x-2 pt-2 border-t border-slate-100">
                    ...
                    <button type="submit" onclick="return confirm('Apakah Anda yakin ingin meng-import database ini? Data tabel akan diperbarui sesuai file backup.')" class="px-5 py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-extrabold rounded-xl text-xs shadow-lg shadow-amber-600/20 transition">
