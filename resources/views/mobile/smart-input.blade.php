        ...
        <template x-if="inputMode === 'new'">
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <select name="supplier_id" x-model="supplierId" class="w-full px-3 py-2.5 bg-slate-100 rounded-2xl border border-slate-200 font-semibold text-slate-800 text-xs">
...
function smartInputApp(allProducts) {
    return {
        ...
        switchToUpdateMode(prod) {
            ...
            this.supplierId = prod.supplier_id || '';
            this.hpp = prod.hpp;
