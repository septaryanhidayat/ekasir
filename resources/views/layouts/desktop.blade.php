    ...
    <aside :class="sidebarOpen ? 'translate-x-0 w-64' : '-translate-x-full lg:-translate-x-full lg:w-0 lg:p-0 lg:overflow-hidden'"
        ...
        <nav class="flex-1 p-4 space-y-1.5 overflow-y-auto">
            ...
            <a href="{{ route('backup.download') }}" 
               class="flex items-center px-4 py-3 rounded-xl text-sm font-semibold transition hover:bg-slate-800 text-slate-400 hover:text-white">
                <svg class="w-5 h-5 mr-3 shrink-0 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
